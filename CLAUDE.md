...
- **`rdf/entries.py`** — `load_entries(path_or_text, base)`: tell-syntax entry files, ground and pattern lines; used by the harness and the CLI `--entries` flag.
...
772 tests across 34 test files:
...
**RDF extension (157 tests, 12 files):**
